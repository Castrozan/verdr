...
The runner does not yet import JUnit, coverage, mutation, or flake history; compare historical evidence; calibrate judges; run paired instruction experiments; or evaluate composed installations. Native runtime support covers Codex discovery and MCP invocation, Claude Code discovery, OpenCode skill invocation, and Pi skill discovery and queue expansion. The HTML report states these limits instead of presenting an overall quality score.
